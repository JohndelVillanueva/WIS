    ...
    <div class="row">
        <div class="col-lg-12">
            <header class="text-center">
				...
				<h2>Westfields International School</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="row">
									<div class="col-lg-12">
										<h3 class="text-center">Basic Student Information</h3>
										<hr>
									</div>
								</div>
                                <div class="row">
                                ...
                                <div class="row py-3">
                                    <div class="col-lg-2">
                                        ...
                                        <input type="date" class="form-control" id="dob" name="dob"
                                               placeholder="Date of Birth" onchange="fnCalculateAge()" required>
                                    </div>
                                    <div class="col-lg-1">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="guardianemail" name="guardianemail"
                                                   placeholder="Guardian's Email" required>
                                        </div>
                                        <div class="col-lg-2">
											...
											<div class="accordion" id="faq">
												<div class="card">
													<div class="card-header" id="faqhead1">
														...
														aria-expanded="true" aria-controls="faq1">Terms and Conditions of Enrollment</a>
													</div>
												...
												<div class="card">
													<div class="card-header" id="faqhead2">
														...
														aria-expanded="true" aria-controls="faq2">Agreement for Early Enrollment</a>
													</div>
												...
												<div class="card">
													<div class="card-header" id="faqhead3">
														...
														aria-expanded="true" aria-controls="faq3">Model Release</a>
													</div>
												...
												<div class="card">
													<div class="card-header" id="faqhead4">
														...
														aria-expanded="true" aria-controls="faq4">Policy on Student Fees</a>
													</div>
												...
												<div class="card">
													<div class="card-header" id="faqhead5">
														...
														aria-expanded="true" aria-controls="faq5">Policy on Refunds</a>
													</div>
													...
													<div id="faq5" class="collapse" aria-labelledby="faqhead5" data-parent="#faq">
														<div class="card-body">
															<div>
																...
																<table class="table">
																	<thead>
																		<tr><th>TIME OF WITHDRAWAL</th><th>REFUND</th>
																	</tr></thead>
																	<tbody>
																		<tr>
																			<td>1.1 Before the official start of classes</td><td>Total amount paid less service charge of ₱ 35,000.00</td>
																		</tr>
																		<tr>
																			<td>1.2 Within the first (1<sup>st</sup>) week of classes</td><td>Total amount paid less 20% of the total amount paid and a service charge of ₱ 35,000.00</td>
																		</tr>
																		<tr>
																			<td>1.3 Within the second (2<sup>nd</sup>) week of classes</td><td>Total amount paid less 30% of the total amount paid and a service charge pf ₱ 35,000.00</td>
																		</tr>
																		<tr>
																			<td>1.4 Beyond two weeks from the start of classes</td><td>NO refund and will be required to pay in full</td>
																		</tr>
																		<tr>
																			<td>RESERVATION FEE</td><td>NON-REFUNDABLE</td>
																		</tr>
																	</tbody>
																</table>
