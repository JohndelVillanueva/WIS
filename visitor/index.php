				...
				<div class="col-md-12 animateMe">
					<div class="wrapper p-5">
                        ...
                        <div class="form-group">
                            <input class="form form-control form-control-lg" name="guestname" type="text" autofocus placeholder="Name of Visitor" required>
                        </div>
                        <div class="form-group">
                            <input class="form form-control form-control-lg" name="guestcomment" type="text" placeholder="Remarks">
                        </div>
                        <div class="form-group">
                            <input class="form form-control form-control-lg" type="password" name="rfid" placeholder="Click here and tap RFID Card" required>
                        </div>
