									...
									<div class="row my-3">
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="street" name="street"
                                                   placeholder="Number and Street" value="<?php echo $row["street"]; ?>" required>
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="barangay">Barangay / Subdivision</label>
                                            <input type="text" class="form-control" id="barangay" name="barangay"
                                                   placeholder="Mother's Email" value="<?php echo $row["barangay"]; ?>" required>
                                        </div>
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="postal" name="postal"
                                                   placeholder="Postal Code" value="<?php echo $row["postal"]; ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-2">
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="lang" name="lang"
                                                   placeholder="Major Languages at home" value="<?php echo $row["languages"]; ?>" required>
                                        </div>
            							<div class="col-lg-2">
                                            <label for="alc">ALC</label>
                                            <input type="text" class="form-control" id="alc" name="alc"
                                                   placeholder="ALC" value="<?php echo $row["advclasses"]; ?>" required>
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="remedial">Remedial School</label>
                                            <input type="text" class="form-control" id="remedial" name="remedial"
                                                   placeholder="Remedial School" value="<?php echo $row["remedial"]; ?>" required>
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="skill">Special Skill</label>
                                            <input type="text" class="form-control" id="skill" name="skill"
                                                   placeholder="Special Skill" value="<?php echo $row["skill"]; ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 mt-5 text-center">
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="asthmadets" name="asthmadets"
                                                   placeholder="Asthma Remarks" required>
                                        </div>
                                        <div class="col-lg-1">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="allergiesdets" name="allergiesdets"
                                                   placeholder="Allergy Remarks" required>
                                        </div>
                                        <div class="col-lg-1">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="dallergiesdets" name="dallergiesdets"
                                                   placeholder="Drug Allergy Remarks" required>
                                        </div>
										<div class="col-lg-1">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="speechdets" name="speechdets"
                                                   placeholder="Speech Remarks" required>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-1 ">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="visiondets" name="visiondets"
                                                   placeholder="Vision Remarks" required>
                                        </div>
                                        <div class="col-lg-1">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="hearingdets" name="hearingdets"
                                                   placeholder="Hearing Remarks" required>
                                        </div>
                                        <div class="col-lg-1">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="adhddets" name="adhddets"
                                                   placeholder="ADHD Remarks" required>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="healthcond" name="healthcond"
                                                   placeholder="Other Conditions" required>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="hospitalization" name="hospitalization"
                                                   placeholder="Hospitalization" required>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="medication" name="medication"
                                                   placeholder="State name of Medication and Frequency" required>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control" id="generaldets" name="generaldets"
                                                   placeholder="HG Remarks" required>
                                        </div>
                                        <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control" id="psychdets" name="psychdets"
                                                   placeholder="Psychological Remarks" required>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-3">
