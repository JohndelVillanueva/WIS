...
<body>
    <div class="app">
        <div class="layout">
            ...
            <?php
            $pdo_statement = $DB_con->prepare("SELECT user.*, studentdetails.* FROM user INNER JOIN studentdetails ON user.uniqid = studentdetails.uniqid WHERE user.id = :id");
                                    ...
                                    <div class="card">
                                        ...
                                        <div class=" col-lg-3">
                                                ...
                                                <div class="col-lg-1">
                                                    ...
                                                    <select class="custom-select" id="suffix" name="suffix">
                                            ...
                                            <div class="row my-3">
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" id="street" name="street" placeholder="Number and Street" value="<?php echo $row["street"]; ?>" required>
                                                </div>
                                                <div class="col-lg-3">
                                                    <label for="barangay">Barangay / Subdivision</label>
                                                    <input type="text" class="form-control" id="barangay" name="barangay" placeholder="Mother's Email" value="<?php echo $row["barangay"]; ?>" required>
                                                </div>
                                                <div class="col-lg-3">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" id="postal" name="postal" placeholder="Postal Code" value="<?php echo $row["postal"]; ?>" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <label for="father">Father's Name</label>
                                                    <input type="text" class="form-control" id="father" name="father" placeholder="Father's Name" value="<?php echo $row["father"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="fathermail">Father's Email</label>
                                                    <input type="text" class="form-control" id="fathermail" name="fathermail" placeholder="Father's Email" value="<?php echo $row["fathermail"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="fatherphone">Father's Phone Number</label>
                                                    <input type="text" class="form-control" id="fatherphone" name="fatherphone" placeholder="Father's Phone Number" value="<?php echo $row["fathernumber"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="fatherwork">Father's Occupation</label>
                                                    <input type="text" class="form-control" id="fatherwork" name="fatherwork" placeholder="Father's Occupation" value="<?php echo $row["fjob"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="fathercompany">Father's Company</label>
                                                    <input type="text" class="form-control" id="fathercompany" name="fathercompany" placeholder="Father's Company" value="<?php echo $row["fcompany"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    ...
                                                    <select class="custom-select" id="fsalaryrange" class="form-select" name="fsalaryrange">
                                                        <option value="<?php echo $row["fsalary"]; ?>" selected><?php echo $row["fsalary"]; ?></option>
                                                        <option value="">-- select one --</option>
                                            ...
                                            <div class="row my-3">
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control" id="mother" name="mother" placeholder="Mother's Name" value="<?php echo $row["mother"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="mothermail">Mother's Email</label>
                                                    <input type="text" class="form-control" id="mothermail" name="mothermail" placeholder="Mother's Email" value="<?php echo $row["mothermail"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="motherphone">Mothers's Phone Number</label>
                                                    <input type="text" class="form-control" id="motherphone" name="motherphone" placeholder="Mothers's Phone Number" value="<?php echo $row["mothernumber"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="motherwork">Mother's Occupation</label>
                                                    <input type="text" class="form-control" id="motherwork" name="motherwork" placeholder="Mother's Occupation" value="<?php echo $row["mjob"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="mothercompany">Mother's Company</label>
                                                    <input type="text" class="form-control" id="mothercompany" name="mothercompany" placeholder="Mother's Company" value="<?php echo $row["mcompany"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    ...
                                                    <select class="custom-select" id="msalaryrange" class="form-select" name="msalaryrange">
                                                        <option value="<?php echo $row["msalary"]; ?>" selected><?php echo $row["msalary"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="P 0 - P 50 000">P 0 - P 50 000</option>
                                                        <option value="P 50 001 - P 100 000">P 50 001 - P 100 000</option>
                                                        <option value="P 100 001 - P 200 000">P 100 001 - P 200 000</option>
                                            ...
                                            <div class="row my-3">
                                                <div class="col-lg-2">
                                                    ...
                                                    <select class="custom-select" id="english1" class="form-select" name="english1" required>
                                                        <option value="<?php echo $row["englishrw"]; ?>" selected><?php echo $row["englishrw"]; ?></option>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <select class="custom-select" id="english2" class="form-select" name="english2" required>
                                                        <option value="<?php echo $row["englishv"]; ?>" selected><?php echo $row["englishv"]; ?></option>
                                                        <option value="" disabled>-- select one --</option>
                                                        <option value="Good">Good</option>
                                                        <option value="Fair">Fair</option>
                                                        <option value="Limited">Limited</option>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control" id="lang" name="lang" placeholder="Major Languages at home" value="<?php echo $row["languages"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="alc">ALC</label>
                                                    <input type="text" class="form-control" id="alc" name="alc" placeholder="ALC" value="<?php echo $row["advclasses"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="remedial">Remedial School</label>
                                                    <input type="text" class="form-control" id="remedial" name="remedial" placeholder="Remedial School" value="<?php echo $row["remedial"]; ?>" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="skill">Special Skill</label>
                                                    <input type="text" class="form-control" id="skill" name="skill" placeholder="Special Skill" value="<?php echo $row["skill"]; ?>" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 mt-5 text-center">
                                            ...
                                            <div class="row my-3">
                                                <div class="col-lg-1 ">
                                                    ...
                                                    <select class="custom-select" id="asthma" class="form-select" name="asthma" required>
                                                        <option value="<?php echo $row["asthma"]; ?>" selected><?php echo $row["asthma"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control" id="asthmadets" name="asthmadets" placeholder="Asthma Remarks" required>
                                                </div>
                                                <div class="col-lg-1">
                                                    <label for="allergies">Allergy</label>
                                                    <select class="custom-select" id="allergies" class="form-select" name="allergies" required>
                                                        <option value="<?php echo $row["allergy"]; ?>" selected><?php echo $row["allergy"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control" id="allergiesdets" name="allergiesdets" placeholder="Allergy Remarks" required>
                                                </div>
                                                <div class="col-lg-1">
                                                    ...
                                                    <select class="custom-select" id="dallergies" class="form-select" name="dallergies" required>
                                                        <option value="<?php echo $row["drug"]; ?>" selected><?php echo $row["drug"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control" id="dallergiesdets" name="dallergiesdets" placeholder="Drug Allergy Remarks" required>
                                                </div>
                                                <div class="col-lg-1">
                                                    <label for="speech">Speech</label>
                                                    <select class="custom-select" id="speech" class="form-select" name="speech" required>
                                                        <option value="<?php echo $row["speech"]; ?>" selected><?php echo $row["speech"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control" id="speechdets" name="speechdets" placeholder="Speech Remarks" required>
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-lg-1 ">
                                                    ...
                                                    <select class="custom-select" id="vision" class="form-select" name="vision" required>
                                                        <option value="<?php echo $row["vision"]; ?>" selected><?php echo $row["vision"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" id="visiondets" name="visiondets" placeholder="Vision Remarks" required>
                                                </div>
                                                <div class="col-lg-1">
                                                    <label for="hearing">Hearing Problems</label>
                                                    <select class="custom-select" id="hearing" class="form-select" name="hearing" required>
                                                        <option value="<?php echo $row["hearing"]; ?>" selected><?php echo $row["hearing"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" id="hearingdets" name="hearingdets" placeholder="Hearing Remarks" required>
                                                </div>
                                                <div class="col-lg-1">
                                                    <label for="adhd">ADHD</label>
                                                    <select class="custom-select" id="adhd" class="form-select" name="adhd" required>
                                                        <option value="<?php echo $row["adhd"]; ?>" selected><?php echo $row["adhd"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" id="adhddets" name="adhddets" placeholder="ADHD Remarks" required>
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-lg-6">
                                                    <label for="healthcond">Any other health condition that te school should be aware of?</label>
                                                    <input type="text" class="form-control" id="healthcond" name="healthcond" placeholder="Other Conditions" required>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label for="hospitalization">Has your child recently been hospitalized?</label>
                                                    <input type="text" class="form-control" id="hospitalization" name="hospitalization" placeholder="Hospitalization" required>
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-lg-6">
                                                    <label for="injuries">Has your child recently had any serious injuries? Why?</label>
                                                    <input type="text" class="form-control" id="injuries" name="injuries" placeholder="Injuries" required>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label for="medication">Is your child on regular medication?</label>
                                                    <input type="text" class="form-control" id="medication" name="medication" placeholder="State name of Medication and Frequency" required>
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-lg-2">
                                                    ...
                                                    <select class="custom-select" id="general" class="form-select" name="general" required>
                                                        <option value="<?php echo $row["general"]; ?>" selected><?php echo $row["general"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control" id="generaldets" name="generaldets" placeholder="HG Remarks" required>
                                                </div>
                                                <div class="col-lg-2">
                                                    <label for="psych">Psychological</label>
                                                    <select class="custom-select" id="psych" class="form-select" name="psych" required>
                                                        <option value="<?php echo $row["psych"]; ?>" selected><?php echo $row["psych"]; ?></option>
                                                        <option value="">-- select one --</option>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control" id="psychdets" name="psychdets" placeholder="Psychological Remarks" required>
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-lg-3">
                                                    ...
                                                    <select class="custom-select" id="minor" class="form-select" name="minor" required>
                                                        <option value="<?php echo $row["minor"]; ?>" selected><?php echo $row["minor"]; ?></option>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <select class="custom-select" id="emergency" class="form-select" name="emergency" required>
                                                        <option value="<?php echo $row["emergency"]; ?>" selected><?php echo $row["emergency"]; ?></option>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <select class="custom-select" id="hospital" class="form-select" name="hospital" required>
                                                        <option value="<?php echo $row["hospital"]; ?>" selected><?php echo $row["hospital"]; ?></option>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <select class="custom-select" id="otc" class="form-select" name="otc" required>
                                                        <option value="<?php echo $row["otc"]; ?>" selected><?php echo $row["otc"]; ?></option>
                                        ...
                                        <div class="card-footer bg-light text-center">
                                            <button class="btn btn-primary btn-lg" disabled>Commit Changes</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
