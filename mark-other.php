...
try {
    ...
    $body = "
    <p>Hello Ma'am/Sir,</p>
    <p>Your child's attendance for the activity '<strong>$activity</strong>' has been recorded successfully.</p>
    <p><strong>Payment Status:</strong> $payment_status</p>
    <p><strong>Processed By:</strong> $process_by</p>
    <p><strong>Attendance:</strong> {$getInformation->totalAttendance}/{$getInformation->session}</p>
    
    <p style='font-weight: italic; font-size: 16px; color: #707070;'>
        Thank you! Have a nice day.
    </p>

    <p>- Westfields International School</p>
";
