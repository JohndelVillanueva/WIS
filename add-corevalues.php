                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-header bg-warning"><h4 class="pt-2"><span class="icon-holder"><i class="anticon anticon-diff"></i></span> Add Core Values - <?php echo $_GET["grade"]." - ".$_GET["section"]." Quarter ".$_GET["qtr"]; ?></h4></div>
                                <div class="card-body">
                                    <?php
                                    $corevalues = $DB_con->prepare("SELECT * FROM s_studentcv WHERE subjid = :subjid");
                                    $corevalues->execute(array(":subjid"=>$_GET["code"]));
