			...
			<div class="row">
				<div class="col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6">
					<div class="profile-card card rounded-lg shadow p-4 p-xl-5 mb-4 text-center position-relative overflow-hidden">
						...
						<h4 class="mb-4">Guest WIFI Voucher Kiosk</h4>
						<div class="text-left mb-4">
							...
							<div class="input-group mb-2">
								...
								<input type="text" name="time" class="form-control form-control-lg" id="inlineFormInputGroup" placeholder="Time Limit" value="60">
							</div><br>
							<div class="input-group mb-2">
