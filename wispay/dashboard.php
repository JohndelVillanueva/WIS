                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="display table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $pdo_statement = $DB_con->prepare("SELECT wispay.*, user.fname AS fname, user.lname AS lname FROM wispay INNER JOIN user ON wispay.rfid = user.rfid WHERE position = 'Student' ORDER by wispay.id DESC");
