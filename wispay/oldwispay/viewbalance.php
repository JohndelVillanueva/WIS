...
?>
    ...
    <div class="container pt-2">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="text-center text-primary">Transaction History [<?php echo $_GET['rfid']; ?>]</h2><br>
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        $rtbalance->execute(array(':rfid' => $_GET["rfid"]));
                    ...
                    $xhistory = $pdo_conn->prepare("SELECT W.rfid, W.refcode, W.total, W.transcode, W.transdate, U.rfid, U.fname, U.lname FROM wispay W INNER JOIN user U ON W.rfid = U.rfid WHERE W.rfid = :rfid");
                    $xhistory->execute(array(':rfid' => $_GET["rfid"]));
