    ...
    <div class="content">
        <div class="card">
            <div class="firstinfo"><img src="img/wispay.png"/>
                <form action="reloadpay.php" method="post">
                <div class="profileinfo">
                    <h2><?php echo $row["fname"].' '.$row["lname"]; ?></h2>
                    <input type="hidden" name="rfid" id="rfid" value="<?php echo $_GET['rfid']; ?>">
                    ...
                    <small id="amount" class="form-text text-muted">Enter reload amount.</small>
                    <button type="submit" class="hidden" name="submit">Pay</button>
                </div>
                </form>
            </div>
        </div>
        <div class="badgescard"> <span class="	glyphicon glyphicon-shopping-cart"></span> Reloading WISpay&trade;</div>
    </div>
</body>
<?php
    }
