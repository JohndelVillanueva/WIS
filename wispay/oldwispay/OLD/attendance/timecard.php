                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav nav-pills navbar-right">
                                <li class="text-primary"><a href="attendance.php"><span class="glyphicon glyphicon glyphicon-chevron-left"></span> Go Back</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                ...
                <div class="container">
                    ...
                    <?php
                          ...
                          <h1><strong>ERROR!</strong> No record found.</h1>
                        </div>";
                                }
                    ?>
                </div>
