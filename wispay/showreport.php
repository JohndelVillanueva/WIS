                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <table id="userlist" class="table table-striped table-hover">
                                            ...
                                            $query = "SELECT W.rfid, W.refcode, W.credit, W.debit, W.refcode, W.transdate, U.rfid, U.fname, U.lname FROM wispay W INNER JOIN user U ON W.rfid = U.rfid WHERE transdate BETWEEN :from AND :to ";
                                            if($_POST["type"]=="debit"){
                                                $query .= "AND debit > 0";
