                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="userlist" class="display table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $pdo_statement = $DB_con->prepare("SELECT wispay.*, user.fname AS fname, user.lname AS lname FROM wispay INNER JOIN user ON wispay.rfid = user.rfid ORDER BY transdate");
                                    ...
                                    foreach($result as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="text-danger"><?php echo $row['debit']; ?></span></td>
                                            <td><span class="text-success"><?php echo $row['credit']; ?></span></td>
