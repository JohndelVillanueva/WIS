<?php include_once "includes/config.php"; session_start();?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="lastname" name="lastname"
                                                   placeholder="Last Name" required value="<?php echo $row["lname"]; ?>">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="firstname">First Name</label>
                                            <input type="text" class="form-control" id="firstname" name="firstname"
                                                   placeholder="First Name" required value="<?php echo $row["fname"]; ?>">
                                        </div>
                                        <div class="col-lg-2">
                                    ...
                                    <div class="row py-3">
                                        ...
                                        <div class="col-lg-1">
                                            ...
                                            <select class="custom-select" id="gradelevel" class="form-select" name="gradelevel"
                                                    required>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <select class="custom-select" id="section" class="form-select" name="section"
                                                    required>
                                                <option value="<?php if(!empty($row['section'])) { echo $row['section'];} ?>" selected><?php if(!empty($row['section'])) { echo $row['section'];} ?></option>
                                                <option value="">-- select one --</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="guardian" name="guardian"
                                                   placeholder="Guardian's Name" required value="<?php echo $row["guardianname"]; ?>">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="guardianemail">Guardian's Email</label>
                                            <input type="text" class="form-control" id="guardianemail" name="guardianemail"
                                                   placeholder="Guardian's Email" required value="<?php echo $row["guardianemail"]; ?>">
                                        </div>
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="guardianphone" name="guardianphone"
                                                   placeholder="Guardian's Phone Number" required value="<?php echo $row["guardianphone"]; ?>">
                                        </div>
                                        <div class="col-lg-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mt-5 text-center">
                                            <p class="h2">Additional Details</p><hr>
                                        </div>
                                    </div>
                                        <?php
									...
									<div class="row my-3">
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="street" name="street"
                                                   placeholder="Number and Street" required value="<?php if(!empty($irow['street'])) { echo $irow['street'];} ?>">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="barangay">Barangay / Subdivision</label>
                                            <input type="text" class="form-control" id="barangay" name="barangay"
                                                   placeholder="Mother's Email" required value="<?php if(!empty($irow['barangay'])) { echo $irow['barangay'];} ?>">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="city">City</label>
                                            <input type="text" class="form-control" id="city" name="city"
                                                   placeholder="City" required value="<?php if(!empty($irow['city'])) { echo $irow['city'];} ?>">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="postal">Postal Code</label>
                                            <input type="text" class="form-control" id="postal" name="postal"
                                                   placeholder="Postal Code" required value="<?php if(!empty($irow['postal'])) { echo $irow['postal'];} ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="father" name="father"
                                                   placeholder="Father's Name" required value="<?php if(!empty($irow['street'])) { echo $irow['street'];} ?>">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="fathermail">Father's Email</label>
                                            <input type="text" class="form-control" id="fathermail" name="fathermail"
                                                   placeholder="Father's Email" required value="<?php if(!empty($irow['fathermail'])) { echo $irow['fathermail'];} ?>">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="fatherphone">Father's Phone Number</label>
                                            <input type="text" class="form-control" id="fatherphone" name="fatherphone"
                                                   placeholder="Father's Phone Number" required value="<?php if(!empty($irow['fathernumber'])) { echo $irow['fathernumber'];} ?>">
                                        </div>
										<div class="col-lg-2">
                                            <label for="fatherwork">Father's Occupation</label>
                                            <input type="text" class="form-control" id="fatherwork" name="fatherwork"
                                                   placeholder="Father's Occupation" required value="<?php if(!empty($irow['fatherwork'])) { echo $irow['fatherwork'];} ?>">
                                        </div>
										<div class="col-lg-2">
                                            <label for="fathercompany">Father's Company</label>
                                            <input type="text" class="form-control" id="fathercompany" name="fathercompany"
                                                   placeholder="Father's Company" required value="<?php if(!empty($irow['fatherwork'])) { echo $irow['fatherwork'];} ?>">
                                        </div>
										<div class="col-lg-2">
                                            ...
                                            <select class="custom-select" id="fsalaryrange" class="form-select" name="fsalaryrange">
                                                <option value="<?php if(!empty($irow['fsalary'])) { echo $irow['fsalary'];} ?>" selected><?php if(!empty($irow['fsalary'])) { echo $irow['fsalary'];} ?></option>
												<option value="">-- select one --</option>
                                    ...
                                    <div class="row my-3">
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="mother" name="mother"
                                                   placeholder="Mother's Name" required value="<?php if(!empty($irow['mother'])) { echo $irow['mother'];} ?>">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="mothermail">Mother's Email</label>
                                            <input type="text" class="form-control" id="mothermail" name="mothermail"
                                                   placeholder="Mother's Email" required value="<?php if(!empty($irow['mothermail'])) { echo $irow['mothermail'];} ?>">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="motherphone">Mothers's Phone Number</label>
                                            <input type="text" class="form-control" id="motherphone" name="motherphone"
                                                   placeholder="Mothers's Phone Number" required value="<?php if(!empty($irow['mothernumber'])) { echo $irow['mothernumber'];} ?>">
                                        </div>
										<div class="col-lg-2">
                                            <label for="motherwork">Mother's Occupation</label>
                                            <input type="text" class="form-control" id="motherwork" name="motherwork"
                                                   placeholder="Mother's Occupation" required value="<?php if(!empty($irow['motherwork'])) { echo $irow['motherwork'];} ?>">
                                        </div>
										<div class="col-lg-2">
                                            <label for="mothercompany">Mother's Company</label>
                                            <input type="text" class="form-control" id="mothercompany" name="mothercompany"
                                                   placeholder="Mother's Company" required value="<?php if(!empty($irow['mcompany'])) { echo $irow['mcompany'];} ?>">
                                        </div>
										<div class="col-lg-2">
                                            ...
                                            <option value="<?php if(!empty($irow['msalary'])) { echo $irow['msalary'];} ?>" selected><?php if(!empty($irow['msalary'])) { echo $irow['msalary'];} ?></option>
                                                <option value="">-- select one --</option>
                                                <option value="P 0 - P 50 000">P 0 - P 50 000</option>
												<option value="P 50 001 - P 100 000">P 50 001 - P 100 000</option>
												<option value="P 100 001 - P 200 000">P 100 001 - P 200 000</option>
                                    ...
                                    <div class="row my-3">
                                        <div class="col-lg-2">
                                            ...
                                            <select class="custom-select" id="english1" class="form-select" name="english1"
                                                    required>
                                                <option value="<?php if(!empty($irow['englishrw'])) { echo $irow['englishrw'];} ?>" selected><?php if(!empty($irow['englishrw'])) { echo $irow['englishrw'];} ?></option>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <select class="custom-select" id="english2" class="form-select" name="english2"
                                                    required>
                                                <option value="<?php if(!empty($irow['englishv'])) { echo $irow['englishv'];} ?>" selected><?php if(!empty($irow['englishv'])) { echo $irow['englishv'];} ?></option>
                                                <option value="" disabled>-- select one --</option>
                                                <option value="Good">Good</option>
                                                <option value="Fair">Fair</option>
                                                <option value="Limited">Limited</option>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="lang" name="lang"
                                                   placeholder="Major Languages at home" required value="<?php if(!empty($irow['languages'])) { echo $irow['languages'];} ?>">
                                        </div>
            							<div class="col-lg-2">
                                            <label for="alc">ALC</label>
                                            <input type="text" class="form-control" id="alc" name="alc"
                                                   placeholder="ALC" required value="<?php if(!empty($irow['advclasses'])) { echo $irow['advclasses'];} ?>">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="remedial">Remedial School</label>
                                            <input type="text" class="form-control" id="remedial" name="remedial"
                                                   placeholder="Remedial School" required value="<?php if(!empty($irow['remedial'])) { echo $irow['remedial'];} ?>">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="skill">Special Skill</label>
                                            <input type="text" class="form-control" id="skill" name="skill"
                                                   placeholder="Special Skill" required value="<?php if(!empty($irow['skill'])) { echo $irow['skill'];} ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 mt-5 text-center">
                                            <p class="h2">Medical Information and Health History</p><hr>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-1 ">
                                            ...
                                            <select class="custom-select" id="asthma" class="form-select" name="asthma"
                                                    required>
                                                    <option value="<?php if(!empty($irow['ashtma'])) { echo $irow['ashtma'];} ?>" selected><?php if(!empty($irow['ashtma'])) { echo $irow['ashtma'];} ?></option>
                                                <option value="">-- select one --</option>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="asthmadets" name="asthmadets"
                                                   placeholder="Asthma Remarks" required value="<?php if(!empty($irow['ashtmar'])) { echo $irow['ashtmar'];} ?>">
                                        </div>
                                        <div class="col-lg-1">
                                            <label for="allergies">Allergy</label>
                                            <select class="custom-select" id="allergies" class="form-select" name="allergies"
                                                    required>
                                                    <option value="<?php if(!empty($irow['allergy'])) { echo $irow['allergy'];} ?>" selected><?php if(!empty($irow['allergy'])) { echo $irow['allergy'];} ?></option>
                                                <option value="">-- select one --</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="allergiesdets" name="allergiesdets"
                                                   placeholder="Allergy Remarks" required value="<?php if(!empty($irow['allergyr'])) { echo $irow['allergyr'];} ?>">
                                        </div>
                                        <div class="col-lg-1">
                                            <label for="dallergies">Drug Allergy</label>
                                            <select class="custom-select" id="dallergies" class="form-select" name="dallergies"
                                                    required>
                                                    <option value="<?php if(!empty($irow['allergyr'])) { echo $irow['allergyr'];} ?>" selected><?php if(!empty($irow['allergyr'])) { echo $irow['allergyr'];} ?></option>allergyr
                                                <option value="">-- select one --</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="dallergiesdets" name="dallergiesdets"
                                                   placeholder="Drug Allergy Remarks" required value="<?php if(!empty($irow['drugr'])) { echo $irow['drugr'];} ?>">
                                        </div>
										<div class="col-lg-1">
                                            <label for="speech">Speech</label>
                                            <select class="custom-select" id="speech" class="form-select" name="speech"
                                                    required>
                                                    <option value="<?php if(!empty($irow['speech'])) { echo $irow['speech'];} ?>" selected><?php if(!empty($irow['speech'])) { echo $irow['speech'];} ?></option>
                                                <option value="">-- select one --</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="speechdets" name="speechdets"
                                                   placeholder="Speech Remarks" required value="<?php if(!empty($irow['speechr'])) { echo $irow['speechr'];} ?>">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-1 ">
                                            ...
                                            <select class="custom-select" id="vision" class="form-select" name="vision"
                                                    required>
                                                    <option value="<?php if(!empty($irow['vision'])) { echo $irow['vision'];} ?>" selected><?php if(!empty($irow['vision'])) { echo $irow['vision'];} ?></option>
                                                <option value="">-- select one --</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="visiondets" name="visiondets"
                                                   placeholder="Vision Remarks" required value="<?php if(!empty($irow['visionr'])) { echo $irow['visionr'];} ?>">
                                        </div>
                                        <div class="col-lg-1">
                                            <label for="hearing">Hearing Problems</label>
                                            <select class="custom-select" id="hearing" class="form-select" name="hearing"
                                                    required>
                                                    <option value="<?php if(!empty($irow['hearing'])) { echo $irow['hearing'];} ?>" selected><?php if(!empty($irow['hearing'])) { echo $irow['hearing'];} ?></option>
                                                <option value="">-- select one --</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="hearingdets" name="hearingdets"
                                                   placeholder="Hearing Remarks" required value="<?php if(!empty($irow['hearingr'])) { echo $irow['hearingr'];} ?>">
                                        </div>
                                        <div class="col-lg-1">
                                            <label for="adhd">ADHD</label>
                                            <select class="custom-select" id="adhd" class="form-select" name="adhd"
                                                    required>
                                                <option value="<?php if(!empty($irow['adhd'])) { echo $irow['adhd'];} ?>" selected><?php if(!empty($irow['adhd'])) { echo $irow['adhd'];} ?></option>
                                                <option value="">-- select one --</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="adhddets" name="adhddets"
                                                   placeholder="ADHD Remarks" required value="<?php if(!empty($irow['adhdr'])) { echo $irow['adhdr'];} ?>">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-6">
                                            <label for="healthcond">Any other health condition that te school should be aware of?</label>
                                            <input type="text" class="form-control" id="healthcond" name="healthcond"
                                                   placeholder="Other Conditions" required value="<?php if(!empty($irow['healthcond'])) { echo $irow['healthcond'];} ?>">
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="hospitalization" name="hospitalization"
                                                   placeholder="Hospitalization" required value="<?php if(!empty($irow['hospitalization'])) { echo $irow['hospitalization'];} ?>">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="injuries" name="injuries"
                                                   placeholder="Injuries" required value="<?php if(!empty($irow['injuries'])) { echo $irow['injuries'];} ?>">
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="medication" name="medication"
                                                   placeholder="State name of Medication and Frequency" required value="<?php if(!empty($irow['medication'])) { echo $irow['medication'];} ?>">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-2">
                                            ...
                                            <select class="custom-select" id="general" class="form-select" name="general"
                                                    required>
                                                <option value="<?php if(!empty($irow['general'])) { echo $irow['general'];} ?>" selected><?php if(!empty($irow['general'])) { echo $irow['general'];} ?></option>
                                                <option value="">-- select one --</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control" id="generaldets" name="generaldets"
                                                   placeholder="HG Remarks" required value="<?php if(!empty($irow['generaldets'])) { echo $irow['generaldets'];} ?>">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="psych">Psychological</label>
                                            <select class="custom-select" id="psych" class="form-select" name="psych"
                                                    required>
                                                <option value="<?php if(!empty($irow['psych'])) { echo $irow['psych'];} ?>" selected><?php if(!empty($irow['psych'])) { echo $irow['psych'];} ?></option>
                                                <option value="">-- select one --</option>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control" id="psychdets" name="psychdets"
                                                   placeholder="Psychological Remarks" required value="<?php if(!empty($irow['psychdets'])) { echo $irow['psychdets'];} ?>">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-lg-3">
                                            ...
                                            <select class="custom-select" id="minor" class="form-select" name="minor"
                                                    required>
                                                <option value="<?php if(!empty($irow['minor'])) { echo $irow['minor'];} ?>" selected><?php if(!empty($irow['minor'])) { echo $irow['minor'];} ?></option>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="custom-select" id="emergency" class="form-select" name="emergency"
                                                    required>
                                                <option value="<?php if(!empty($irow['emergency'])) { echo $irow['emergency'];} ?>" selected><?php if(!empty($irow['emergency'])) { echo $irow['emergency'];} ?></option>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="custom-select" id="hospital" class="form-select" name="hospital"
                                                    required>
                                                <option value="<?php if(!empty($irow['hospital'])) { echo $irow['hospital'];} ?>" selected><?php if(!empty($irow['hospital'])) { echo $irow['hospital'];} ?></option>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="custom-select" id="otc" class="form-select" name="otc"
                                                    required>
                                                <option value="<?php if(!empty($irow['otc'])) { echo $irow['otc'];} ?>" selected><?php if(!empty($irow['otc'])) { echo $irow['otc'];} ?></option>
