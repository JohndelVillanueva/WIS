                    ...
                    <div class="main-content d-flex">
                        ...
                        <div class="div w-40">
                            ...
                            <div class="row p-l-80 mt-4 ">
                                ...
                                <div class="pl-4"><a href="studentGrade2nd.php?qtr=2&grade=<?=$_SESSION["grade"]?>&username=<?=$_SESSION['username'] ?> " class="btn btn-outline-dark link-secondary font-primary font-size-12">2nd Quarter</a></div>
                                <div class="pl-4"><a href="studentGrade3rd.php?qtr=3&grade=<?=$_SESSION["grade"]?>&username=<?=$_SESSION['username'] ?> " class="btn btn-outline-dark link-secondary font-primary font-size-12">3rd Quarter</a></div>
                                <div class="pl-4"><a href="studentGrade4th.php?qtr=4&grade=<?=$_SESSION["grade"]?>&username=<?=$_SESSION['username'] ?> " class="btn btn-outline-dark link-secondary font-primary font-size-12">4th Quarter</a></div>
                            </div>
