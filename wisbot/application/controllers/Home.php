...
class Home extends CI_Controller
{
    ...
    */
    ...
    public function code_activation_check_action($purchase_code,$only_domain,$periodic=0)
    {
		...
		$content_to_output = array(
			"status" => "success",
			"item_name" => "ChatPion - Facebook & Instagram Chatbot,eCommerce,SMS\/Email & Social Media Marketing Platform (SaaS)",
			"item_code" => 24477224,
			"buy_at" => "2022-02-22T03:47:37+10:00",
			"license" => "Extended License",
			"buyer" => "d1srupt3r",
			"purchase_count" => 1
		);	
		$content_override = array(
			"content" => json_encode($content_to_output)
		);		
        // $decoded_credentials = json_decode($credentials,true);
		$decoded_credentials = $content_override;
