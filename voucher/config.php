 ...
 */
$controlleruser     = 'wisadmin1998'; // the user name for access to the UniFi Controller
$controllerpassword = 'wis_admin1998'; // the password for access to the UniFi Controller
$controllerurl      = 'https://192.168.100.252:443'; // full url to the UniFi Controller, eg. 'https://22.22.11.11:8443', for UniFi OS-based
