                                ...
                                <form method="post" action="process-grades.php" id="processgrades">
                                    ...
                                    <div class="card-body">
                                        ...
                                        foreach ($result as $row) {
                                            // code here
                                            $getstudents = $DB_con->prepare("SELECT * FROM user WHERE section = :section AND gender = :gender ORDER BY lname ASC");
                                            $getstudents->execute(array(":section" => $_GET["section"], ":gender" => "M"));
                                        ...
                                        foreach ($result as $row) {
                                            // code here
                                            $getstudents = $DB_con->prepare("SELECT * FROM user WHERE section = :section AND gender = :gender ORDER BY lname ASC");
                                            $getstudents->execute(array(":section" => $_GET["section"], ":gender" => "F"));
                                            $studres = $getstudents->fetchAll();
